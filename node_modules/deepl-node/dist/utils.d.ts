...
/// <reference types="node" />
/// <reference types="node" />
import { Formality, GlossaryInfo, GlossaryId, LanguageCode, NonRegionalLanguageCode, RequestParameters, TranslateTextOptions } from './types';
 ...
 * @private
 */
export declare function buildURLSearchParams(sourceLang: LanguageCode | null, targetLang: LanguageCode, formality: Formality | undefined, glossary: GlossaryId | GlossaryInfo | undefined, extraRequestParameters: RequestParameters | undefined): URLSearchParams;
/**
